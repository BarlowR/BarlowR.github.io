...
::photo{src="photos/bridge-1.jpg" style="float: right; width:39%;"}
...
::photo{src="photos/kern-canyon.jpg" style="float: left; width:39%;"}
...
::photo{src="photos/hail.jpg" style="float: left; width:46%;"}
...
::photo{src="photos/sun.jpg" style="float: left; width:46%;"}


::photo{src="photos/fish-on.jpg" style="float: left; width:46%;"}
...
::cesium-view{gpx="trip.gpx" clamp-to-ground="true"}
