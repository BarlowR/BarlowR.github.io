...
::book{title="Birds of America" author="Lorrie Moore"}
...
::book{title="They Can't Kill Us Until They Kill Us" author="Abdurraqib, Hanif"}

::book{title="The Order of Time" author="Carlo Rovelli"}

::book{title="Six Memos for the New Millenia" author="Italo Calvino"}


## Training
<hr>

::book{title="9 Out of 10 Climbers Make the Same Mistakes" author="Dave MacLeod"}

:::book{title="Training for the Uphill Athlete" author="Kílian Jornet, Scott Johnston, and Steve House"}
...
:::book{title="Tactical Barbell" author="K. Black"}
